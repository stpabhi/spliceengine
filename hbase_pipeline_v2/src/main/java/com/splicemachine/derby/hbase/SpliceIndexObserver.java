...
public class SpliceIndexObserver implements RegionCoprocessor, RegionObserver {
    ...
    public void start(final CoprocessorEnvironment e) throws IOException{
        try {
            ...
            ServerControl sc = new RegionServerControl((HRegion)rce.getRegion(),((HasRegionServerServices)rce).getRegionServerServices());
            if(service==null){
