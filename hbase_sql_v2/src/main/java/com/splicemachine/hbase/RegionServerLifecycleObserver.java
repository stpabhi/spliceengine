...
public class RegionServerLifecycleObserver implements RegionServerObserver, RegionServerCoprocessor {
    ...
    private DatabaseLifecycleManager startEngine(CoprocessorEnvironment e) throws IOException{
        RegionServerServices regionServerServices = ((HasRegionServerServices) e).getRegionServerServices();
