...
//        HRegion region = HRegion.openHRegion(conf, fs, rootDir, hri, ReadOnlyHTableDescriptor.newBuilder(htd), null, null, null);
...
//                            store.getColumnFamilyDescriptor().getBloomFilterType(), true
//                    )
//            );
//        }
//
...
//        ((CompactionRequestImpl) compactionRequest).setIsMajor(isMajor, isMajor);
