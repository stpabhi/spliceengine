        ...
        switch (operation) {
            case "tokens": {
                ...
                for (BlockLocation bl : blockLocations) {
                    ...
                    HdfsProtos.LocatedBlockProto lbp = PBHelperClient.convertLocatedBlock(locatedBlock);
            ...
            case "blocks": {
                return Arrays.asList(PBHelperClient.convert(HDFSUtil.getBlocks((DistributedFileSystem)fs, spath)).toByteArray());
            }
            case "decrypt": {
