...
public class HServer implements PartitionServer {
  ...
  public  HServer(ServerName serverName, ClusterMetrics clusterStatus) {
    this.serverName = serverName;
    this.clusterMetrics = clusterStatus;
  }
  ...
  public PartitionServerLoad getLoad() throws IOException {
    ServerMetrics metrics = clusterMetrics.getLiveServerMetrics().get(serverName);
    return new HServerLoad(metrics);
  }
